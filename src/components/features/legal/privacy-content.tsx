    ...
    <Section title="4. 外部サービスとの連携">
      ...
      <ul className="ml-4 list-disc space-y-1">
        ...
        <li>
          ...
          レシピタイトルの検索最適化（埋め込みベクトル生成）および食材名のエイリアス自動生成のために利用。送信されるデータにはユーザーが登録したレシピサイトのタイトル・食材情報が含まれます。なお、送信データはGoogleのモデル学習には使用されません
        </li>
        <li>
    ...
    <>
      <Section title="5. データの保管と削除">
        <p>
          ...
          アカウントの削除を希望される場合は、設定画面から削除できます。
